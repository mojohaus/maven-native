...
public class MSVC2019x64EnvFactory extends AbstractMSVC2019EnvFactory {
    ...
    protected Map<String, String> createEnvs() throws NativeBuildException {
        return this.createEnvs("VS160COMNTOOLS", "x64");
    }
}
