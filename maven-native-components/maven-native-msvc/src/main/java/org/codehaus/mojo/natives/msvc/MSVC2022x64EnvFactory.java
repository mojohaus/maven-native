...
public class MSVC2022x64EnvFactory extends AbstractMSVC2022EnvFactory {
    ...
    protected Map<String, String> createEnvs() throws NativeBuildException {
        return this.createEnvs("VS170COMNTOOLS", "x64");
    }
}
