...
public class CLinkerTest extends PlexusTestCase {
    ...
    public void testDefaultLinkerExecutable() throws Exception {
    ...
    public void testOverrideLinkerExecutable() throws Exception {
    ...
    public void testObjectFileList() throws Exception {
        Commandline cl = this.getCommandline();
    ...
    public void testLinkerResponseFile() throws Exception {
    ...
    public void testRelativeObjectFileList() throws Exception {
    ...
    public void testExternalUnixLibraries() throws Exception {
