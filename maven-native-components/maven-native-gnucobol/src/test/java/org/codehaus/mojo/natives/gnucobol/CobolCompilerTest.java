...
public class CobolCompilerTest extends PlexusTestCase {
    ...
    public void testSimpleCompilation() throws Exception {
        ...
        assertArrayEquals(
                new String[] {"cobc", simpleArgv[0], simpleArgv[1], simpleArgv[2], simpleArgv[3]},
                cl.getRawCommandline());
    }

    public void testNonDefaultExecutable() throws Exception {
        this.config.setExecutable("cobol");
        Commandline cl = compiler.getCommandLine(sourceFile, objectFile, config);
        assertArrayEquals(
                new String[] {"cobol", simpleArgv[0], simpleArgv[1], simpleArgv[2], simpleArgv[3]},
                cl.getRawCommandline());
    }

    public void testStartOptions() throws Exception {
    ...
    public void testSystemIncludePaths() throws Exception {
        File[] includePaths = {new File("p1"), new File("p2")};
    ...
    public void testMiddleOptions() throws Exception {
        File[] includePaths = {new File("p1"), new File("p2")};
        config.setIncludePaths(includePaths);
    ...
    public void testEndOptions() throws Exception {
        File[] includePaths = {new File("p1"), new File("p2")};
        config.setIncludePaths(includePaths);
